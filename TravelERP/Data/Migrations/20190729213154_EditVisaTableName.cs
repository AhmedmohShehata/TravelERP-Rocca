...
{
    public partial class EditVisaTableName : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BillVisas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BillVisas_Companies_CompanyID",
                        column: x => x.CompanyID,
                        principalTable: "Companies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BillVisas_CustomerOrSuppliers_CustomerOrSupplierId",
                        column: x => x.CustomerOrSupplierId,
                        principalTable: "CustomerOrSuppliers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BillVisas_CustomersSuppliers_CustomerSupplierId",
                        column: x => x.CustomerSupplierId,
                        principalTable: "CustomersSuppliers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BillVisas_MenuLE0_MenuLE0Id",
                        column: x => x.MenuLE0Id,
                        principalTable: "MenuLE0",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BillVisas_MenuLE1_MenuLE1Id",
                        column: x => x.MenuLE1Id,
                        principalTable: "MenuLE1",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BillVisas_MenuLE2_MenuLE2Id",
                        column: x => x.MenuLE2Id,
                        principalTable: "MenuLE2",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BillVisas_CustomersSuppliers_TicketExportId",
                        column: x => x.TicketExportId,
                        principalTable: "CustomersSuppliers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BillVisas_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillVisas_CompanyID",
                table: "BillVisas",
                column: "CompanyID");

            migrationBuilder.CreateIndex(
                name: "IX_BillVisas_CustomerOrSupplierId",
                table: "BillVisas",
                column: "CustomerOrSupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_BillVisas_CustomerSupplierId",
                table: "BillVisas",
                column: "CustomerSupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_BillVisas_MenuLE0Id",
                table: "BillVisas",
                column: "MenuLE0Id");

            migrationBuilder.CreateIndex(
                name: "IX_BillVisas_MenuLE1Id",
                table: "BillVisas",
                column: "MenuLE1Id");

            migrationBuilder.CreateIndex(
                name: "IX_BillVisas_MenuLE2Id",
                table: "BillVisas",
                column: "MenuLE2Id");

            migrationBuilder.CreateIndex(
                name: "IX_BillVisas_TicketExportId",
                table: "BillVisas",
                column: "TicketExportId");

            migrationBuilder.CreateIndex(
                name: "IX_BillVisas_UserId",
                table: "BillVisas",
                column: "UserId");
        }
