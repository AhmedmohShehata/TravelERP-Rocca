...
namespace TravelERP.Data.Migrations
{
    ...
    [Migration("20190716190923_EditEznTableMenus")]
    partial class EditEznTableMenus
    {
            ...
            modelBuilder.Entity("TravelERP.Models.Ezn", b =>
                {
                    ...
                    b.HasOne("TravelERP.Models.MenuLZ0", "MenuLE0")
                        .WithMany()
                        .HasForeignKey("MenuLE0Id")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("TravelERP.Models.MenuLZ1", "MenuLE1")
                        .WithMany()
                        .HasForeignKey("MenuLE1Id")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("TravelERP.Models.MenuLZ2", "MenuLE2")
                        .WithMany()
                        .HasForeignKey("MenuLE2Id")
                        .OnDelete(DeleteBehavior.Cascade);
