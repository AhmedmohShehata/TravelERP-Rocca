...
namespace TravelERP.Controllers
{
    ...
    public class DevelopersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Message")] Developer developer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Message")] Developer developer)
        {
            if (id != developer.Id)
            {
                return NotFound();
