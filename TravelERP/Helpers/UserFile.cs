...
namespace TravelERP.Helpers
{
    public static class UserFile
    {
        ...
        internal static Task<string> UploadeNewImageAsync(string companyLogo, IFormFile fileLogo, string webRootPath, object imgFolder, int v1, int v2)
        {
